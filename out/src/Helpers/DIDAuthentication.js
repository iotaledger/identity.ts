...
function SignDIDAuthentication(document, keyId, challenge) {
    var credential = Credential_1.Credential.Create(SchemaManager_1.SchemaManager.GetInstance().GetSchema("DIDAuthenticationCredential"), document.GetDID(), { "DID": document.GetDID().GetDID() });
...
exports.VerifyDIDAuthentication = VerifyDIDAuthentication;
//# sourceMappingURL=DIDAuthentication.js.map